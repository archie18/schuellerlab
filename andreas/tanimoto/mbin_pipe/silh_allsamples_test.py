...
# The silhouette_sample gives the silhouette value for each samples.
silhouette_sam = np.empty(n)
silhouette_sam = silhouette_samples(X, labels, metric='precomputed')
print(*silhouette_sam, sep='\n')
