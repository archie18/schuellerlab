...
for algo in open(filename):
	...
	het_nm = s[1]
	pdb_filename = pdb
	tupla.append(Codes(code=pdb.lower(),het=het_file, het_name=het_nm, chain=cad))
...
for l in tupla:
	cmd = "python pdb_parser2.py "+l.code+".pdb "+l.het_name+" "+l.chain+" "+ workdir+" "+l.code+"_"+l.het_name 
	os.system(cmd)
